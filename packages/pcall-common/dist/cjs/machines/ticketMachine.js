...
exports.createTicketMachineService = exports.createTicketMachine = void 0;
/* eslint-disable @typescript-eslint/no-non-null-assertion */
const nanoid_1 = require("nanoid");
const ticket_1 = require("../models/ticket");
const xstate_1 = require("xstate");
const showMachine_1 = require("./showMachine");
const createTicketMachine = ({ ticketDocument, showDocument, showMachineOptions, }) => {
    const parentShowMachine = (0, showMachine_1.createShowMachine)({
        showDocument,
        showMachineOptions,
    });
    ...
    return (0, xstate_1.createMachine)({
        ...
        entry: (0, xstate_1.assign)(() => {
            const showMachineRef = (0, xstate_1.spawn)(parentShowMachine, {
        ...
        actions: {
            sendJoinedShow: (0, xstate_1.send)((context) => ({
                type: "CUSTOMER JOINED",
                ticket: context.ticketDocument,
            }), { to: (context) => context.showMachineRef }),
            sendLeftShow: (0, xstate_1.send)((context) => ({
                type: "CUSTOMER LEFT",
                ticket: context.ticketDocument,
            }), { to: (context) => context.showMachineRef }),
            sendTicketSold: (0, xstate_1.send)((context) => ({
                type: "TICKET SOLD",
                ticket: context.ticketDocument,
            ...
            sendTicketRefunded: (0, xstate_1.send)((context) => ({
            ...
            sendTicketCancelled: (0, xstate_1.send)((context) => ({
            ...
            initiateCancellation: (0, xstate_1.assign)((context, event) => {
                return {
                    ticketState: {
                        ...context.ticketState,
                        status: ticket_1.TicketStatus.CANCELLATION_INITIATED,
                        cancel: event.cancel,
                    },
                };
            }),
            redeemTicket: (0, xstate_1.assign)((context) => {
                if (context.ticketState.status === ticket_1.TicketStatus.REDEEMED)
                    return {};
                return {
                    ticketState: {
                        ...context.ticketState,
                        status: ticket_1.TicketStatus.REDEEMED,
                        redemption: {
                            redeemedAt: new Date(),
                        },
                    },
            ...
            cancelTicket: (0, xstate_1.assign)((context) => {
                return {
                    ticketState: {
                        ...context.ticketState,
                        status: ticket_1.TicketStatus.CANCELLED,
                    },
                };
            }),
            receivePayment: (0, xstate_1.assign)((context, event) => {
            ...
            receiveRefund: (0, xstate_1.assign)((context, event) => {
            ...
            receiveFeedback: (0, xstate_1.assign)((context, event) => {
                return {
                    ticketState: {
                        ...context.ticketState,
            ...
            initiateDispute: (0, xstate_1.assign)((context, event) => {
                return {
                    ticketState: {
                        ...context.ticketState,
                        status: ticket_1.TicketStatus.IN_DISPUTE,
                        dispute: event.dispute,
                    },
                };
            }),
            enterEscrow: (0, xstate_1.assign)((context) => {
                return {
                    ticketState: {
                        ...context.ticketState,
                        status: ticket_1.TicketStatus.IN_ESCROW,
                        escrow: {
            ...
            finalizeTicket: (0, xstate_1.assign)((context) => {
                const finalized = {
                    finalizedAt: new Date(),
                };
                if (context.ticketState.status !== ticket_1.TicketStatus.FINALIZED) {
                    return {
                        ticketState: {
                            ...context.ticketState,
                            finalized: finalized,
                            status: ticket_1.TicketStatus.FINALIZED,
                        },
                    };
                }
                return {};
            }),
            deactivateTicket: (0, xstate_1.assign)((context) => {
                return {
                    ticketState: {
                        ...context.ticketState,
                        active: false,
            ...
            missShow: (0, xstate_1.assign)((context) => {
                return {
                    ticketState: {
                        ...context.ticketState,
                        status: ticket_1.TicketStatus.MISSED_SHOW,
                    },
                };
            }),
        },
        guards: {
            ...
            ticketCancelled: (context) => context.ticketState.status === ticket_1.TicketStatus.CANCELLED,
            ticketFinalized: (context) => context.ticketState.status === ticket_1.TicketStatus.FINALIZED,
            ticketInDispute: (context) => context.ticketState.status === ticket_1.TicketStatus.IN_DISPUTE,
            ticketInEscrow: (context) => context.ticketState.status === ticket_1.TicketStatus.IN_ESCROW,
            ticketReserved: (context) => context.ticketState.status === ticket_1.TicketStatus.RESERVED,
            ticketReedemed: (context) => context.ticketState.status === ticket_1.TicketStatus.REDEEMED,
            ticketInCancellationInitiated: (context) => context.ticketState.status === ticket_1.TicketStatus.CANCELLATION_INITIATED,
            ticketMissedShow: (context) => context.ticketState.status === ticket_1.TicketStatus.MISSED_SHOW,
...
exports.createTicketMachine = createTicketMachine;
const createTicketMachineService = ({ ticketDocument, ticketMachineOptions, showDocument, showMachineOptions, }) => {
    const ticketMachine = (0, exports.createTicketMachine)({
        ticketDocument,
        ticketMachineOptions,
        showDocument,
        showMachineOptions,
    });
    const ticketService = (0, xstate_1.interpret)(ticketMachine).start();
    ...
    if (showMachineOptions?.saveShowEventCallback) {
        ...
        showService.onEvent((event) => {
            ...
            const transactions = ("transactions" in event ? event.transactions : []);
...
exports.createTicketMachineService = createTicketMachineService;
