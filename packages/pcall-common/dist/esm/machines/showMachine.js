...
import { ShowStatus } from "../models/show";
export const createShowMachine = ({ showDocument, showMachineOptions, }) => {
    ...
    return createMachine({
        ...
        guards: {
            ...
            showInitiatedCancellation: (context) => context.showState.status === ShowStatus.CANCELLATION_INITIATED,
...
export const createShowMachineService = ({ showDocument, showMachineOptions, }) => {
