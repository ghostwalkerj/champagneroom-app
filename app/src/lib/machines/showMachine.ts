...
import type { actions } from '../../routes/(website)/proxy+page.server';
  ...
  return setup(
    {
      ...
      guards: {
        ...
        canStartShow: (
          ...
          if (params.show.showState.status === ShowStatus.STOPPED) {
            ...
            const startDate = new Date(
              params.show.showState.runtime!.startDate
            );
        ...
        disputesResolved:  (
          ...
          return (
            params.show.showState.disputeStats.totalDisputesPending -
              resolved ===
            0
          );
        }
