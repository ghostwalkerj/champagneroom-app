...
const tablePayouts: TableSource = {
    ...
    // The data visibly shown in your table body UI.
    body: tableMapperValues(payouts, ['finalEarnedAt', 'finalAmount', 'finalStatus'])
};
...
<div class="bg-surface-900 w-modal p-4 rounded flex flex-col gap-4 overflow-y-auto max-h-[90vh]">
