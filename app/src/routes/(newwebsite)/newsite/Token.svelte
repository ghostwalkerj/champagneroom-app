...
<div id="SignUp" class="container mx-auto mt-20">
  ...
  <div class="grid grid-cols-1 md:grid-cols-3 gap-4 mt-36">
    <div
      class="col-span-1 md:col-span-1 flex items-center"
      data-aos="fade-right"
    >
      <div>
        <h2 class="text-white text-4xl">Titano Tokenomics Explained</h2>
        <br />
        <hr class="bg-[#28e0b2] h-1" />
        <br />
    ...
    <div class="col-span-1 md:col-span-1" data-aos="fade-down">
      <div class="m-4 p-14 bg-[#50626517] rounded-3xl">
        <div class="mb-2 m-auto flex">
          <span class=" m-auto">
            <svg
        ...
        <br />
        <h3 class="text-[#d0dce8] text-3xl text-center mb-3 font-semibold">
          Automate LP
        </h3>

        <p class="text-[#d0dce8] text-center mb-3 font-normal mt-3">
          5% of the trading fees return to the liquidity ensuring $TITANO's
          increasing collateral value.
        </p>
      </div>
      <div class="m-4 p-14 bg-[#50626517] rounded-3xl mt-5" data-aos="fade-up">
        <div class="mb-2 m-auto flex">
          <span class="m-auto">
            <svg
              xmlns="http://www.w3.org/2000/svg"
        ...
        <p class="text-[#d0dce8] text-center mb-3 font-normal mt-3">
          3% of the purchases and 8% of the sales go directly to the treasury
          which supports the RFV.
        </p>
      </div>
    </div>
    <div
      ...
      data-aos="fade-left"
    >
      <div class="m-4 p-14 bg-[#50626517] rounded-3xl mt-5">
        <div class="mb-2 m-auto flex">
          <span class="m-auto">
            <svg
              xmlns="http://www.w3.org/2000/svg"
        ...
        <p class="text-[#d0dce8] text-center mb-3 font-normal mt-3">
          5% of the trading fees are redirected to the RFV which helps sustain
          and back the staking rewards provided by the positive rebase.
        </p>
      </div>
    </div>
  </div>
