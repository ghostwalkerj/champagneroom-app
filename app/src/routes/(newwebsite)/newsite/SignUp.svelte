    ...
    <div class="mt-20">
      ...
      <div class="flex flex-col lg:flex-row mt-10">
        ...
        <div class="w-full flex flex-col place-content-center">
          <div
            class="text-info font-['SpaceGrotesk'] text-2xl font-bold capitalize m-5 tracking-wider text-center"
          >
          ...
          <div data-aos="fade-down" class="h-full flex place-content-center">
            ...
            {:else}
              ...
              >
                <select
                  class="select select-primary w-full max-w-xs bg-black"
                  name="interest"
                >
                ...
                <input
                  ...
                  placeholder="Email"
                  name="email"
                  class="input input-bordered input-primary w-[300px] bg-black"
                />
