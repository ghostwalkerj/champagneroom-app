    ...
    <div class="mx-auto w-full lg:max-w-4xl">
      ...
      <div class="relative pb-4 text-center">
        ...
        {#if canWatchShow && hasShowStarted}
          <div
            class="bg-base-200/50 text-primary-500-500 absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 -rotate-6 transform whitespace-nowrap rounded-xl p-2 text-2xl font-extrabold ring-2 ring-inset ring-primary-500 lg:text-4xl"
          >
            <button
      ...
      {#if !isTicketDone && !isShowInEscrow}
        <div class="relative">
          ...
          {#if hasPaymentSent}
            <div
              class="bg-base-200/50 text-primary-500-500 absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 -rotate-45 transform whitespace-nowrap rounded-xl p-2 text-2xl font-extrabold ring-2 ring-inset ring-primary-500 lg:text-3xl"
            >
