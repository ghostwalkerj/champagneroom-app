...
var config = {
    ...
    // type:  Array<{ icon: string; id: string; text: string; }>
     customToolbarButtons: [{
	    icon: 'data:image/svg+xml;base64,',
            id: 'leave-show',
            text: 'Leave Show',
          },],
    ...
    // https://firebase.goog le.com/docs/dynamic-links/create-manually
    ...
    */
    ...
    defaultLogoUrl: 'https://static.champagneroom.app/assets/logo-horizontal-tr.png',
