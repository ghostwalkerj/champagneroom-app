<script>
  import { Video } from 'lib/jitsi-svelte';
      ...
      <tr>
        ...
        <td>
          {#if $participant.audioEnabled}
            <button on:click={() => participant.setAudioEnabled(false)}
              >mute</button
            >
          {:else}
            <button on:click={() => participant.setAudioEnabled(true)}
              >unmute</button
            >
          {/if}
        </td>
      ...
      <tr>
        ...
        <td>
          {#if $participant.videoEnabled}
            <button on:click={() => participant.setVideoEnabled(false)}
              >mute</button
            >
          {:else}
            <button on:click={() => participant.setVideoEnabled(true)}
              >unmute</button
            >
          {/if}
        </td>
      ...
      <tr>
        ...
        <td>
          {#if $participant.desktopEnabled}
            <button on:click={() => participant.setDesktopEnabled(false)}
              >mute</button
            >
          {:else}
            <button on:click={() => participant.setDesktopEnabled(true)}
              >unmute</button
            >
          {/if}
        </td>
