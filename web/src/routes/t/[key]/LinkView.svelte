  ...
  <div class="text-center card-body items-center">
    ...
    {#if link && linkMachineState && !linkMachineState.done}
      <div class="container mx-auto grid p-6 gap-4 grid-row-2">
        <div
          class="text-center card-body items-center bg-secondary rounded-2xl"
        >
          <div class="text-xl w-full">
            ...
            {:else if linkMachineState.matches('claimed')}
              <div class="w-full ">
                ...
                <div
                  class="p-6 flex flex-row w-full place-content-evenly items-center"
                >
                  <div
            ...
            {:else if linkMachineState.matches('inEscrow')}
              ...
              >
                <div>
                  <div>
                    {spacetime(
                      (claim.call?.endedAt || claim.call?.startedAt || 0) +
                        ESCROW_PERIOD
                    ).format('nice-short')}
                  </div>
                </div>
        ...
        >
          ...
          {#if linkMachineState.context.linkState.totalFunding >= link.requestedAmount}
            ...
            <button on:click={copyLink}>
              <div class="cursor-pointer flex group">
                ...
                <div class="text-sm group-hover:text-white">
                  <div
                    class="tooltip tooltip-accent {tooltipOpen}"
                    data-tip="Copied!"
                  />
                </div>
              </div>
